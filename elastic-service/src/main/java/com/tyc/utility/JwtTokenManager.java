...
import com.tyc.exception.ElasticServiceException;
...
public class JwtTokenManager {
    ...
    public String createToken(Long authId) {
        ...
        try {
            ...
            token = JWT.create()
                    ...
                    .withIssuedAt(new Date()) // Olusturma zamani
    ...
    public Optional<Long> getByIdFromToken(String token) {
        try {
            ...
            if(decodedToken == null) throw new ElasticServiceException(ErrorType.INVALID_TOKEN);
